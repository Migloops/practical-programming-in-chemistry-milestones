...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/Migloops                                               | 
| 1    | Github Profile Page                         | https://github.com/Migloops/Migloops                                    |
| 1    | Commit and Push Change from Command Line    | https://github.com/Migloops/ppchem/commit/8a98db6a9ba81a5c610476e4a9d566e13b2d7fab                |
| 1    | Create a New Branch                         | https://github.com/Migloops/ppchem/tree/new-branch-name             |
| 1    | Create a conda environment                  | https://github.com/Migloops/ppchem/blob/main/env.yml      |
| 1    | Fork a Repo                                 | https://github.com/Migloops/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/Migloops/practical-programming-in-chemistry-milestones/pull/1#issue-2186553569 |
